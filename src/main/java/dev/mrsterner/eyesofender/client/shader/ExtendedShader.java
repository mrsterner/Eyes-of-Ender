...
public class ExtendedShader extends ShaderProgram {
        ...
        if (jsonarray.size() != j && jsonarray.size() > 1) {
            ...
            if (i <= 3) {
                ...
                if (getHolder().uniforms.contains(name)) {
                    getHolder().defaultUniformData.add(new IntegerUniformData(name, i, new int[]{(int) afloat[0], (int) afloat[1], (int) afloat[2], (int) afloat[3]}));
                }
            } else if (i <= 7) {
            ...
            if (i > 3) {
                if (getHolder().uniforms.contains(name)) {
                    getHolder().defaultUniformData.add(new FloatUniformData(name, i, afloat));
                }
            }
    ...
    public class FloatUniformData extends UniformData {
    ...
    public class IntegerUniformData extends UniformData {
