...
import dev.mrsterner.eyesofender.EyesOfEnderClient;
...
public class CoffinBlockEntityRenderer<T extends BlockEntity> implements BlockEntityRenderer<T>{
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData top = bone.addChild("top", ModelPartBuilder.create().uv(0, 35).cuboid(0.0F, -1.0F, -15.0F, 14.0F, 1.0F, 30.0F, new Dilation(0.0F))
                ...
                .uv(58, 35).cuboid(1.0F, -0.5F, -14.0F, 12.0F, 1.0F, 28.0F, new Dilation(0.0F)), ModelTransform.of(-8.0F, -1.0F, 14.0F, 0.0F, 0.0F, -0.7854F));
        ...
        ModelPartData base = bone.addChild("base", ModelPartBuilder.create().uv(0, 0).cuboid(-16.0F, 5.0F, 0.0F, 16.0F, 3.0F, 32.0F, new Dilation(0.0F))
                ...
                .uv(31, 92).cuboid(-2.5F, -2.5F, 1.5F, 1.0F, 6.0F, 29.0F, new Dilation(0.0F))
                .uv(31, 92).cuboid(-14.5F, -2.5F, 1.5F, 1.0F, 6.0F, 29.0F, new Dilation(0.0F))
                .uv(0, 8).cuboid(-13.5F, -2.5F, 1.5F, 11.0F, 6.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 8).cuboid(-13.5F, -2.5F, 29.5F, 11.0F, 6.0F, 1.0F, new Dilation(0.0F))
    ...
    public void render(T entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        if (block instanceof CoffinBlock) {
            if (world != null && world.isClient()){
                ...
                var g = blockState.get(CoffinBlock.OPEN);
    ...
    public void render(MatrixStack matrices, VertexConsumer vertices, ModelPart base, ModelPart lid, boolean openFactor, int light, int overlay, BlockState blockState, float tickDelta) {
        if(blockState.get(CoffinBlock.COFFIN_TYPE) == CoffinType.FOOT){
            ...
            lid.roll = 0;
            lid.roll = lid.roll - degToRad(openProgress);
